...
* Added: Category lock.
* Added: Passter Protected Area Gutenberg wrapper block.

= 4.2.29 - 12.02.2026 =
* Fixed: Password validation and unlock link generation failing when the password contains the % character.
...
* Changed: Made password form input IDs unique per protected area to prevent duplicate IDs when using multiple forms on the same page.
